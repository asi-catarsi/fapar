...
do
	...
	ciop-log "INFO" "Starting fapar processor [/bin/sh /application/CATARSI/batch_Processor/FAPAR_and_LAI/run_fapar.sh /usr/local/MATLAB/MATLAB_Compiler_Runtime/v76/ $myInputDir $myOutputDir]"

	/bin/sh /application/CATARSI/batch_Processor/FAPAR_and_LAI/run_fapar.sh /usr/local/MATLAB/MATLAB_Compiler_Runtime/v76/ $myInputDir $myOutputDir
